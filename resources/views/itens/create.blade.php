        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{ url('/dashboard/admin/produtos') }}">Produtos</a>
                        <i class="fa fa-circle"></i>
                    </li>
                    <li>
            ...
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h1 class="page-title"> Criar Produto
                <small>Crie um novo produto</small>
            </h1>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
            <!-- Formulário -->
                        ...
                        <div class="portlet-body">
                            <div class="m-grid">
                                    <div class="m-grid-col m-grid-col-md-12 m-grid-col-middle">
                                        <div class="form-body">
                                            {!! Form::open(['url' => 'dashboard/admin/produtos/create', 'files' => true]) !!}
