...
<div class="content">
    ...
    <form class="login-form" action="{{ url('/password/reset') }}" method="post">
        ...
        <h3 class="form-title font-green">Recuperar Senha</h3>
        @if (count($errors) > 0)
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" name="email" value="{{ $email or old('email') }}" placeholder="Email" /> </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Password</label>
            <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Confirme a senha" name="password_confirmation" /> </div>
        <div class="form-actions">
            <button type="submit" class="btn green uppercase">Recuperar Senha e Logar</button>
        </div>
    </form>
    <!-- END LOGIN FORM -->
